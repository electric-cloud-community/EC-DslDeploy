#  
#  deployEnvironmentTemplated.pl - Loop through the environment templates 
#      and invoke each individually. 
#  
...
use Cwd 'abs_path';
my $dslFile = abs_path('deployEnvironmentTemplated.$[/myJob/id].commandDsl');
