#  
#  deployWorkflowDefinitions.pl - Loop through the workflowDefinitions and invoke each individually
#  
...
use Cwd 'abs_path';
my $dslFile = abs_path('deployWorkflowDefinitions.$[/myJob/id].commandDsl');
